...
const STRINGS = {
  en: {
    commands: {
      ...
      tip: "Show a link if you'd like to support the developer with a coffee ☕",
      optionA: 'Your weapon position (X / Y), e.g. "71.67 / 78.64"',
      optionB: 'Target / enemy base position (X / Y), e.g. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: 'The position of **your own weapon** (mortar or artillery tank), read from the in-game map, in "X / Y" format.',
      whatIsBName: 'What is "b"?',
      whatIsBValue: 'The position of the **target** (enemy base, spotted enemy, etc.), read from the in-game map, in "X / Y" format.',
    ...
    tip: {
      ...
      description: "If you enjoy using Wardogs Calculator, you can buy the developer a coffee here: {url}\nNo pressure at all — thanks for using the bot! 🎯",
    },
  ...
  pl: {
    commands: {
      ...
      tip: 'Pokaż link, jeśli chcesz postawić twórcy kawę ☕',
      optionA: 'Pozycja Twojej broni (X / Y), np. "71.67 / 78.64"',
      optionB: 'Pozycja celu / bazy wroga (X / Y), np. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: 'Pozycja **Twojej własnej broni** (moździerz lub Artillery Tank), odczytana z mapy w grze, w formacie "X / Y".',
      whatIsBName: 'Czym jest "b"?',
      whatIsBValue: 'Pozycja **celu** (baza wroga, namierzony przeciwnik itp.), odczytana z mapy w grze, w formacie "X / Y".',
    ...
    tip: {
      title: '☕ Wesprzyj twórcę',
      description: 'Jeśli podoba Ci się Wardogs Calculator, możesz postawić twórcy kawę tutaj: {url}\nBez żadnej presji — dzięki za korzystanie z bota! 🎯',
    },
  ...
  es: {
    commands: {
      ...
      tip: 'Muestra un enlace si quieres invitar un café al desarrollador ☕',
      optionA: 'Posición de tu arma (X / Y), ej. "71.67 / 78.64"',
      optionB: 'Posición del objetivo / base enemiga (X / Y), ej. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: 'La posición de **tu propia arma** (mortero o artillery tank), leída del mapa del juego, en formato "X / Y".',
      whatIsBName: '¿Qué es "b"?',
      whatIsBValue: 'La posición del **objetivo** (base enemiga, enemigo detectado, etc.), leída del mapa del juego, en formato "X / Y".',
    ...
    tip: {
      ...
      description: 'Si te gusta usar Wardogs Calculator, puedes invitar un café al desarrollador aquí: {url}\nSin ninguna presión — ¡gracias por usar el bot! 🎯',
    },
  ...
  fr: {
    commands: {
      ...
      tip: 'Affiche un lien si vous voulez offrir un café au développeur ☕',
      optionA: 'Position de votre arme (X / Y), ex. "71.67 / 78.64"',
      optionB: 'Position de la cible / base ennemie (X / Y), ex. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: "La position de **votre propre arme** (mortier ou artillery tank), lue sur la carte du jeu, au format \"X / Y\".",
      whatIsBName: 'Qu\'est-ce que "b" ?',
      whatIsBValue: "La position de la **cible** (base ennemie, ennemi repéré, etc.), lue sur la carte du jeu, au format \"X / Y\".",
    ...
    tip: {
      ...
      description: "Si vous aimez utiliser Wardogs Calculator, vous pouvez offrir un café au développeur ici : {url}\nAucune pression — merci d'utiliser le bot ! 🎯",
    },
  ...
  pt: {
    commands: {
      ...
      tip: 'Mostra um link caso queira pagar um café para o desenvolvedor ☕',
      optionA: 'Posição da sua arma (X / Y), ex. "71.67 / 78.64"',
      optionB: 'Posição do alvo / base inimiga (X / Y), ex. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: 'A posição da **sua própria arma** (morteiro ou artillery tank), lida no mapa do jogo, no formato "X / Y".',
      whatIsBName: 'O que é "b"?',
      whatIsBValue: 'A posição do **alvo** (base inimiga, inimigo avistado, etc.), lida no mapa do jogo, no formato "X / Y".',
    ...
    tip: {
      ...
      description: 'Se você gosta de usar o Wardogs Calculator, pode pagar um café para o desenvolvedor aqui: {url}\nSem nenhuma pressão — obrigado por usar o bot! 🎯',
    },
  ...
  de: {
    commands: {
      ...
      tip: 'Zeigt einen Link, falls du dem Entwickler einen Kaffee spendieren möchtest ☕',
      optionA: 'Position deiner Waffe (X / Y), z. B. "71.67 / 78.64"',
      optionB: 'Position des Ziels / der gegnerischen Basis (X / Y), z. B. "68.40 / 82.24"',
    },
    fireMission: {
    ...
    help: {
      ...
      whatIsAValue: 'Die Position **deiner eigenen Waffe** (Mörser oder Artillery Tank), von der Spielkarte abgelesen, im Format "X / Y".',
      whatIsBName: 'Was ist "b"?',
      whatIsBValue: 'Die Position des **Ziels** (gegnerische Basis, entdeckter Gegner usw.), von der Spielkarte abgelesen, im Format "X / Y".',
    ...
    tip: {
      ...
      description: 'Wenn dir Wardogs Calculator gefällt, kannst du dem Entwickler hier einen Kaffee spendieren: {url}\nGanz ohne Druck — danke, dass du den Bot nutzt! 🎯',
    },
